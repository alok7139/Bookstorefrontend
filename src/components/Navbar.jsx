...
function Navbar() {
  ...
  // console.log(authuser);
    ...
    const navitems= (<>
    <Link to='/' className='p-1'><li>Home</li></Link>
    <Link to='/course' className='p-1'><li>Courses</li></Link>
    <Link to='/contact' className='p-1'><li>Contact</li></Link>
    <Link to='/about' className='p-1'> <li>About</li></Link>
    </>)

  return (
   <>
   <div className='py-0'>
    <div className={`max-w-screen-2xl items-stretch container mx-auto dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out' : ''}`}>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer" href='/'>PageTurn</a>  
  </div>
...

  {
    ...
    <a className="bg-blue-500 text-white px-3 py-2 rounded-md hover:bg-slate-300 cursor-pointer" onClick={() => document.getElementById('my_modal_3').showModal()}>Login</a>
    <Login/>
  </div> 
  }
